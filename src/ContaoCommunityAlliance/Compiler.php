...
class Compiler
{
     ...
     */
    public function compile($pharFile = 'cce.phar')
    {
        ...
        $phar = new \Phar($pharFile, 0, 'cce.phar');
        ...
        $this->addFile($phar, new \SplFileInfo(__DIR__ . '/../Composer/Autoload/ClassLoader.php'), false);
...
EOF;
        ...
        return $stub . <<<'EOF'
require 'phar://cce.phar/bin/composer';
